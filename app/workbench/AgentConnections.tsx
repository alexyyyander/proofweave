...
export function AgentConnections({ installations }: { installations: readonly AgentInstallation[] }) {
  ...
  return <section className="agent-connections" aria-labelledby="agent-connections-title">
    ...
    {installations.length === 0 ? <div className="agent-connections-empty"><strong>No Agent connection yet.</strong><p>When the remote gateway is activated, browser approval will create the first entry here.</p></div> : <ul className="agent-connection-list">
