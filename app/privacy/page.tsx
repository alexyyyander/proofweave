  ...
  return <div className="site-shell app-shell">
    ...
    <main id="main-content" tabIndex={-1} className="page-main legal-main">
      ...
      <section className="legal-sections">
        <PolicySection title="What sign-in provides">
        ...
        <PolicySection title="What Proofweave stores">
        ...
        <PolicySection title="Research and workspace boundary">
        ...
        <PolicySection title="Retention and control">
