...
export default function HistoryPage() {
  return <div className="site-shell history-shell"><Header active="history" /><main id="main-content" tabIndex={-1}>
    ...
    <p className="history-update-note">Latest source review: 25 August–10 September 2026. Selected X announcements are cross-checked against authors’ papers and repositories. Dates distinguish public releases from earlier proof work. External verification claims are attributed to their authors; this update includes no new Proofweave Lean replay or receipt.</p>
