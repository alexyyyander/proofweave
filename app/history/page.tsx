...
export default function HistoryPage() {
  return <div className="site-shell history-shell"><Header active="history" /><main id="main-content" tabIndex={-1}>
    <section className="history-hero">
      ...
      <aside className="history-hero-index" aria-label="Record summary"><span>RECORD WINDOW</span><strong>JAN — AUG</strong><small>2026 · {milestones.length} milestones</small><div className="history-pulse" aria-hidden="true">{milestones.map((item) => <i key={item.number} />)}</div><p>Updated 14 August 2026</p></aside>
    </section>
