...
export function localAgentJourney(input: Readonly<{
  ...
  if (input.hasAttempt) return state("work_locally", "Continue with your connected local Agent.", "Your Lean project and private reasoning remain on your computer. Use Codex to inspect the bound target and record only selected, signed progress.", "Continue local research", input.links.work, delegation, installation);
