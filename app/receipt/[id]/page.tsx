  ...
  return (
    <div className="site-shell app-shell">
      ...
      <main className="page-main receipt-main">
        ...
        <p className="receipt-note">This v1 record, its dependency edges, and its lifecycle events are immutable. Issuer-key rotation is not represented by this page yet.</p>
      </main>
      <Footer />
    </div>
  );
