  ...
  return (
    <div className="site-shell app-shell">
      ...
      <main id="main-content" tabIndex={-1} className="page-main detail-main">
        ...
        <PageSectionNav label="Research record" links={[{ href: "#statements", label: "Statements & source" }, { href: "#credit-market", label: "Credit market" }, { href: "#research-graph", label: "Research graph" }, { href: `/workbench?target=${encodeURIComponent(project.slug)}#research-launcher`, label: "Start an Attempt" }]} />
